...
for adb,bdb in pairs(_db)do for cdb,ddb in pairs(bdb(aba))do _da[cdb]=ddb end end end;return aba end
...
aa["objects"]["Container"]=function(...)local ab=da("utils")
local bb=ab.tableCount
return
function(cb,db)local _c=db.getObject("VisualObject")(cb,db)
local ac="Container"local bc={}local cc={}local dc={}local _d;local ad=true;local bd,cd=0,0
...
dca:addForegroundBox(1,1,_da,ada,_ba)end end,1)end}cca.__index=cca;return setmetatable(cca,cc)end end;aa["plugins"]={}
...
error("XMLParser: unclosed ".._c[#_c].tag)end;return ac.children end}return cb end;return aa["main"]()